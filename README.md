...
*The Black Crown Project* pretended to have a tensile strength, an artistic torque built on thickness, and deep permeating foundations. In reality, it was a silica-thin network, a shallow breadth and multitudes next to multitudes with little underneath. It attempted to compensate for this lagoon-like significance with expanse, and a stupefying dreadlock of words.  So, I will try to lay everything out here unpicked and lain out like tools for oiling. It was, after all, somewhat of a tool.
...
In one way, the *Black Crown Project* was created to be an archive of itself. It was about stasis, immortality and [*ruinenwert*](https://en.wikipedia.org/wiki/Ruin_value). If anything so tremulous as a plot occurred, it revealed how dead it really was. It lived in the preterite, and really was a capitulation; if I had had my terrible way, I would have written about something I had done without ever having done it. 

*The Black Crown Project* was an accidental, medieval way to reconfigure a psyche, like a trephination. In many ways, it only made me iller, though perhaps in some ways it led to my recovery. I used to write like this all the time, even in thank-you letters to my godmother, but now I am capable of ocassional lucidity, [as you'll be grateful to find elsewhere](https://github.com/bonfiredog/blackcrownproject/blob/master/INSTRUCTIONS.md). I am happier, and I write less, and probably less well, and at less-auspicious times. It takes me fewer circuits to leave the house, and to love those around me, and to tell them what is wrong. Considering how easily I avoid plot and drama in my work, it is very tempting to be causal here, to irrationally credit the <i>Project</i> with an exorcist quality, drawing out that something-that-wasn't-a-soul like a boggart, making me a better person. But it did not. I can view it with a detachment now, but when I was writing it it was parasitic, chewing when I chewing, hiking when I hiked, moving up my spine inexorably. Even putting together this archive, and writing these words, has awoken some shard of it that still sits underneath my lap, squeezing itself like an inbred python.
...
*The Black Crown Project*, in another way, would have loved to have remained buried, to have remained interred in soil, the perfect memorial to itself; people always knowing where it was yet unable to desecrate it, to catalogue it and reveal its weaknesses; to leave behind only the negative of a robust skeleton, revealing only its genotype and not its phenotypic failings. It would rather be as forgotten as it is possible to be whilst still being powerful. I had that opportunity, to leave it where it was, disintegrating slowly, and beautifully. I considered it. Perhaps it would have been more noble; perhaps it would have shown how much progress I have made, how much healing I have undertaken, to be able to leave it alone for one last time. 
