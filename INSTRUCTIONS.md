...
*The Black Crown Project* was a large work of **interactive fiction**, housed in various decoupled fillets across the Internet. Its players were induced, and induced themselves, to join the Widsith Institute, and were employed to archive, manage and research the belongings and writings of a long-dead tourist. Their play was spread across multiple media and modes, the assets of most of which can be found in this archive. These included:

- A choice-based text game built on Failbetter Games' [Storynexus]() engine, found in the `/main_if` folder;
- Pseudo-3D objects that could be manipulated in a browser, found in the `/objects` folder;
- Recorded voices and sounds, found in the `/audio` folder;
- Fragments of diaries, essays and reports written by the tourist, found in the `/text_shards` folder;
