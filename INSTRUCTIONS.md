...
*The Black Crown Project* was a thin, barely-constituent snot of ideas, characters, narratives and themes, but it held together well. 

At its centre was an interactive fiction, a text game built using Failbetter Games' Storynexus platform in which the player took on the role of their Widsith clerk, did their work and explored the Institute. Like all interactive fictions, Storynexus games involve reading text, making choices as to what to do, and then clicking links to see the consequences of those choices. However, it had several idiosyncracies (better described in Failbetter's own documentation), to which we added several of our own for the Project. The game was split into areas; geographic locations, each denoted by a different banner image, that the clerks could visit. When at their desks, they could choose from various **Files** to attend to, each of which contained a different story thread. Some of these involved doing work at the desk, whereas others allowed them to visit other areas of the game, where they typically completed that one story thread before returning to the desk. Some of these story threads were what Failbetter called **Social Acts**, in which you could send requests to other players to either help you with a story thread, or compete against them; win or lose, there would be consequences.

The player's progress through the game was tracked and marked by **Qualities**; numerical stats which stored information, including the player's health, who they had met, the items they possessed, their current location, and many other indications.

While the game primarily consisted of clicking links, progress was made interesting, and blocked, using three methods; some stories, or branches of stories, had **Quality Requirements**; certain qualities, or numbers of qualities (a certain amount of illness, for example) would be required to progress. Some more interesting branch needed to be paid for to unlock, using Nex, Storynexus' proprietary pseudocurrency. The last feature, an experiment when *The Black Crown Project* was being created, were **Living Stories**; countdown timers that allowed stories to be played after a certain amount of time. Often, players could pay Nex to play them earlier.

Out from this centre came the other forms of *The Black Crown Project*. These were, in general, hosted at normal URLs, with auspicious but plain-English names. This meant that players could be given them as rewards for completing tasks in games, but that they could also be discovered serendipitously by those not yet playing the game, and be drawn in this way. They were also easily shareable. These included 2.5D objects which could be manipulated and rotated in the browser, many of which contained puzzles which, when solved, would lead to a bonus in the game itself; fragments of the Eremite's writings, which could be leafed through and scrutinised; and many supplemental documents, quotes, images, hosted in various places.

The player forums, now sadly gone, were an excellent opportunity for player expression: players could roleplay as their characters in a sort of shared fever-dream, the only chance for clerks to speak to each other, to which I would respond, in the voice of a shared delusion called the Hogherd. Sometimes they were required to post about their character's barely-remembered lives, the forum linked from the storylet they were playing; for the most part, though, it was spontaneous, and wonderful.
